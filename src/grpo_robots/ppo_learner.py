...
class PPOAgent(flax.struct.PyTreeNode):
    ...
    def _update_impl(
        ...
        # Normalize advantages for better numerical stability
        advantages_mean, advantages_std = jax.lax.stop_gradient(advantages.mean()), jax.lax.stop_gradient(advantages.std() + 1e-8)
    ...
    def sample_actions(
        ...
        *,
        ...
        return jnp.clip(actions, -1.0, 1.0), log_probs, values
